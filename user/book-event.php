...
if(isset($_POST['submit'])) {
    ...
    $sql4 = "INSERT into event_content (eventid, staffname, staffmail, staffnumber, studname, studmail, studnumber, eventname, orgdept,
 guestdetails, attclasses, eventtopic, eventduration, wiredmic, chairsaud, lcdproj, ac, chairsstg, podium, othreq, verify, dept)
...
'$event_topic','$event_duration','$wired_mic','$chairs_aud','$lcd_proj','$ac','$chairs_stg','$podium','$oth_req','0','$dept')";
