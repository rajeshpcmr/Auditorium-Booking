                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <table id="viewEvent" class="table table-bordered table-hover">
                                ...
                                $sql="SELECT event_content.* from event_content,event_status WHERE event_content.eventid=event_status.eventid";
                                ...
                                $sql1="SELECT * from event_content WHERE verify=1";
